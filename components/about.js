          ...
          <Grid>
            <Row className="show-grid about">
              <Col xs={12} md={12}>
                <h2> About </h2>
                <p>
                  A majority of outdoor heritage sites do not have the luxury of regular visits from professional conservators yet they are visited daily by hundreds of tourists. Heritage organisations often have a myriad of sites to protect, maintain and conserve; these can vary in type, size and location which makes it difficult to consistently monitor them.
                </p>
                <p>
                ...
                <p>
                  ...
                  The second is issue is that of scale. Different cameras produce different levels of image distortion that can make inferring distances and senses of scale difficult. In order to combat this we have used checkerboards to provide a known scale within the images.
                </p>
